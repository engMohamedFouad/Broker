namespace Broker.Core.Resources
{
    public static class SharedResourcesKeys
    {
        ...
        public const string HasManagement = "HasManagement";
        public const string ReviewNotFound = "ReviewNotFound";
        public const string FailedToUploadFiles = "FailedToUploadFiles";
        public const string FaliedToDeletePhysialFiles = "FaliedToDeletePhysialFiles";
