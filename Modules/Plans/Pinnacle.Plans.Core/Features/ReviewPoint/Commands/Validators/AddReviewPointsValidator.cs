...
{
    public class AddReviewPointsValidator : AbstractValidator<AddReviewPointsCommand>
    {
        #region Fields
        ...
        #region Constructors
        public AddReviewPointsValidator(IStringLocalizer<SharedResources> localizer,
